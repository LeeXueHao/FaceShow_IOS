...
//    [exitButton setBackgroundImage:[UIImage imageNamed:@"关闭拍照页面icon点击态"] forState:UIControlStateHighlighted];
    ...
    cameraBottomView.layer.borderColor = [UIColor colorWithHexString:@"1da1f2"].CGColor;
    [cameraButton setBackgroundImage:[UIImage imageWithColor:[UIColor colorWithHexString:@"1da1f2"]] forState:UIControlStateNormal];
    [exitButton setTitle:@"取消" forState:UIControlStateNormal];
    [exitButton setTitleColor:[UIColor colorWithHexString:@"1da1f2"] forState:UIControlStateNormal];
