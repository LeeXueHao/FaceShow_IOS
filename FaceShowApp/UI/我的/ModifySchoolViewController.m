//
//  ModifySchoolViewController.m
//  FaceShowApp
//
//  Created by niuzhaowang on 2018/4/20.
...
@interface ModifySchoolViewController ()<UITextFieldDelegate>
@property (nonatomic, strong) UITextField *textfield;
@property (nonatomic, strong) UpdateUserInfoRequest *request;
@end

@implementation ModifySchoolViewController
